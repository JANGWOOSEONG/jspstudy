<%--
	지시어(directive)
	1. page 지시어	  : page 설정, import등
	2. include 지시어 : 다른 Jsp를 포함
	3. taglib 지시어  : JSTL/EL 포함 (많이 쓴다)
 --%>
...
<body>
	...
	<%!
		public int getNumber(){
			return (int)(Math.random() * 10); // 0부터 10전까지 0 ~ 9
		}
	%>
	...
	<%--
		...
		1. Java 변수를 JavaScript에서 사용할 수 있다. 있다 !
		2. JavaScript 변수를 Java에서 사용할 수 없다. 없다 !
	 --%>
